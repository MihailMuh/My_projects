...
img_Explosion = os.path.join(game_folder, 'images/Explosion')
img_RegularExplosion = os.path.join(game_folder, 'images/regularExplosion')
img_etg = os.path.join(game_folder, 'images/Explosion_ETG')
...
img_aim1 = pygame.image.load(os.path.join(img_folder, 'cursor (1).png'))
img_aim2 = pygame.image.load(os.path.join(img_folder, 'cursor (2).png'))
img_aim3 = pygame.image.load(os.path.join(img_folder, 'cursor (3).png'))
img_aim4 = pygame.image.load(os.path.join(img_folder, 'cursor (4).png'))
img_aim5 = pygame.image.load(os.path.join(img_folder, 'cursor (5).png'))
img_aim6 = pygame.image.load(os.path.join(img_folder, 'cursor (6).png'))
img_aim7 = pygame.image.load(os.path.join(img_folder, 'cursor (7).png'))
img_aim8 = pygame.image.load(os.path.join(img_folder, 'cursor (8).png'))
...
img_tk_aim1 = Image.open(os.path.join(img_folder, 'aim (1).png'))
img_tk_aim1 = img_tk_aim1.resize((65, 65), Image.ANTIALIAS)
img_tk_aim2 = Image.open(os.path.join(img_folder, 'aim (2).png'))
img_tk_aim2 = img_tk_aim2.resize((65, 65), Image.ANTIALIAS)
img_tk_aim3 = Image.open(os.path.join(img_folder, 'aim (3).png'))
img_tk_aim3 = img_tk_aim3.resize((65, 65), Image.ANTIALIAS)
img_tk_aim4 = Image.open(os.path.join(img_folder, 'aim (4).png'))
img_tk_aim4 = img_tk_aim4.resize((65, 65), Image.ANTIALIAS)
img_tk_aim5 = Image.open(os.path.join(img_folder, 'aim (5).png'))
img_tk_aim5 = img_tk_aim5.resize((65, 65), Image.ANTIALIAS)
img_tk_aim6 = Image.open(os.path.join(img_folder, 'aim (6).png'))
img_tk_aim6 = img_tk_aim6.resize((65, 65), Image.ANTIALIAS)
img_tk_aim7 = Image.open(os.path.join(img_folder, 'aim (7).png'))
img_tk_aim7 = img_tk_aim7.resize((65, 65), Image.ANTIALIAS)
img_tk_aim8 = Image.open(os.path.join(img_folder, 'aim (8).png'))
img_tk_aim8 = img_tk_aim8.resize((65, 65), Image.ANTIALIAS)
...
for i in range(8):
    ...
    img = pygame.image.load(os.path.join(img_RegularExplosion, filename))
...
for i in range(14):
    ...
    img2 = pygame.image.load(os.path.join(img_Explosion, filename2))
